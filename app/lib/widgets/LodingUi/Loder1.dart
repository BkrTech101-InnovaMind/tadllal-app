...
class ColorLoader1 extends StatefulWidget {
  ...
  ColorLoader1({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _ColorLoader1State createState() => _ColorLoader1State();
}

class _ColorLoader1State extends State<ColorLoader1> with TickerProviderStateMixin {
