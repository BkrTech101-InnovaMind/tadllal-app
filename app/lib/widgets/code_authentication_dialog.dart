...
class CodeAuthenticationDialog extends StatefulWidget {
  ...
  const CodeAuthenticationDialog({super.key, 
  ...
  @override
  State<CodeAuthenticationDialog> createState() => _CodeAuthenticationDialogState();
}
...
class _CodeAuthenticationDialogState extends State<CodeAuthenticationDialog> {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      const Row(
                        ...
                        children: [
                          Icon(Icons.done_outline_outlined,color: Color(0xfff48923),),
                          SizedBox(width: 30,),
                          Text("تم الحفظ",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          const Icon(Icons.error_outline,color: Color(0xfff48923),),
                          const SizedBox(width: 30,),
                          SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          MaterialButton(
                            ...
                            splashColor: Colors.redAccent,
                            child: Text('إعادة المحاولة',style: TextStyle(fontSize: 12),),
                          ),
                        ],),
                    ...
                    children: [
                      ...
                      const Row(
                        ...
                        children: [
                          Expanded(
                            flex: 1,
                            child: Icon(Icons.error_outline,color: Color(0xfff48923),),),

                          SizedBox(width: 30,),
                          Expanded(
                            flex: 9,
                            child:Text("حدث خطاء اثناء الحفظ يرجى إعادة المحاولة",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    fontFamily: "Cairo",
                                    color: Color(0xfff48923),
  ...
  Future<Response> _getData() async {
    ...
    return await dioApi.postCodeAuthentication(widget.formValue["path"], myData:  widget.formValue["myData"]);
