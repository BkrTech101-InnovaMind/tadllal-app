                        ...
                        >
                            ...
                            <td key="Actions" className="px-0 py-7 flex flex-row items-center justify-evenly">
                                {(extraButtonType === 'view') && (
                                    <button className="font-medium text-black dark:text-black hover:underline" onClick={() => myFunction(item)}>
                                        <FaEye size={20} />
                                    </button>
                                )}
                                {extraButtonType === 'approve' && (
                                    <button className="font-medium text-green-500 dark:text-green-500 hover:underline" onClick={() => onDelete(item)}>
                                        <FaCheck size={20} />
                                    </button>
                                )}
                ...
                <nav aria-label="Page navigation">
                    <ul className="pagination flex flex-row w-full">
                        ...
                        {Array.from({ length: totalPages }, (_, index) => (
                            (index + 1 === 1 || index + 1 === totalPages || (index + 1 >= currentPage - 1 && index + 1 <= currentPage + 1)) && (
                                <li
                                    key={index}
