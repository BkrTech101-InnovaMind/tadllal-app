...
import { fetchTypes, fetchLocations } from '@/api/fetchData';
...
export default function New() {
    ...
    const checkFormValidity = () => {
        const requiredFields = ['name', 'price', 'description', 'location', 'locationInfo', 'firstType', 'secondType', 'photo'];
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const savedData = await api.post('realEstate/realty/', formDataForApi, authToken);
                ...
                <div className="flex items-center space-x-4 w-full p-4" dir='rtl'>
                    <form className="w-full ">
                        ...
                        <DropDownList
                            ...
                            options={types}
                            onSelect={(e) =>
                                setFormData({ ...formData, firstType: e })
                            }
                        /> <DropDownList
                            title="طبيعة العقار"
                            options={array.data}
                            onSelect={(e) =>
                                setFormData({ ...formData, secondType: e })
                            }
