...
export default function EditService() {
    ...
    const fetchSubServiceData = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                construction_service_id: subServiceData.attributes.construction_service_id,
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            if (formData.construction_service_id !== oldformData.construction_service_id) {
                formDataForApi.append('construction_service_id', formData.construction_service_id);
            }
            if (
                ...
                const response = await api.post(`subServices/${id}/edit`, formDataForApi, authToken);
